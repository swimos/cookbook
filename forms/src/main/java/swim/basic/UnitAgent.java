...
public class UnitAgent extends AbstractAgent {
  ...
  @SwimLane("foo")
  ValueLane<FooType> foo =
      this.<FooType>valueLane()
          .didSet(
              (newValue, oldValue) -> {
  ...
  @SwimLane("addFoo")
  CommandLane<FooType> addFoo =
      this.<FooType>commandLane()
          .onCommand(
              (FooType value) -> {
                this.foo.set(value);
              });
  ...
  @SwimLane("bar")
  ValueLane<BarType> bar =
      this.<BarType>valueLane()
          .didSet(
              (newValue, oldValue) -> {
  ...
  @SwimLane("addBar")
  CommandLane<BarType> addBar =
      this.<BarType>commandLane()
          .onCommand(
              (BarType value) -> {
                this.bar.set(value);
              });
  ...
  // Just included to exercise that the internal lane type is always fundamentally a Value, so this
  // type is compatible with anything.
  @SwimLane("addValue")
  CommandLane<Value> addValue =
