...
1. In a shell, navigate to this directory (`/some/path/cookbook-code/command_lanes/`)
...
3. Unfoo the newly-created `build/distributions/command-lanes-3.9.2.foo`, where "foo" is either "tar" or "zip".

4. Run the `bin/command-lanes` script (`bin\command-lanes.bat` on Windows).
